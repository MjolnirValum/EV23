...
public class ProtoGUI extends javax.swing.JFrame {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ProtoGUITwo vault = new ProtoGUITwo();
        vault.setVisible(true);
        UserPlayer makePlayer = new UserPlayer();
        //this commented out line below was from an earlier iteration before the current iteration was implemented. 
        //VaultLogic vLogic = new VaultLogic(vault, makePlayer);
        VaultLogic vLogic = new VaultLogic();
            vLogic.gameLogic(vault, makePlayer);
            dispose();
